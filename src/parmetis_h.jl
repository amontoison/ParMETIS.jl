...
# Partition a graph
function ParMETIS_V3_PartKway(vtxdist, xadj, adjncy, vwgt, adjwgt, wgtflag, numflag, ncon, nparts, tpwgts, ubvec, options, edgecut, part, comm)
  r = ccall((:ParMETIS_V3_PartKway, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,       vwgt,     adjwgt,    wgtflag,    numflag,       ncon,     nparts,      tpwgts,       ubvec,    options,    edgecut,       part,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
end

function ParMETIS_V3_PartGeomKway(vtxdist, xadj, adjncy, vwgt, adjwgt, wgtflag, numflag, ndims, xyz, ncon, nparts, tpwgts, ubvec, options, edgecut, part, comm)
  r = ccall((:ParMETIS_V3_PartGeomKway, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,       vwgt,     adjwgt,    wgtflag,    numflag,      ndims,         xyz,       ncon,     nparts,      tpwgts,       ubvec,    options,    edgecut,       part,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
end

function ParMETIS_V3_PartGeom(vtxdist, ndims, xyz, part, comm)
  r = ccall((:ParMETIS_V3_PartGeom, libparmetis), Cint,
...
# Partition a mesh
function ParMETIS_V3_PartMeshKway(elmdist, eptr, eind, elmwgt, wgtflag, numflag, ncon, ncommonnodes, nparts, tpwgts, ubvec, options, edgecut, part, comm)
  r = ccall((:ParMETIS_V3_PartMeshKway, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t},   Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
...
function ParMETIS_V3_Mesh2Dual(elmdist, eptr, eind, numflag, ncommonnodes, xadj, adjncy, comm)
  r = ccall((:ParMETIS_V3_Mesh2Dual, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t},   Ptr{idx_t}, Ptr{Ptr{idx_t}}, Ptr{Ptr{idx_t}}, Ptr{idx_t}),
...
function ParMETIS_V3_AdaptiveRepart(vtxdist, xadj, adjncy, vwgt, vsize, adjwgt, wgtflag, numflag, ncon, nparts, tpwgts, ubvec, ipc2redist, options, edgecut, part, comm)
  r = ccall((:ParMETIS_V3_AdaptiveRepart, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{real_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,       vwgt,      vsize,     adjwgt,    wgtflag,    numflag,       ncon,     nparts,      tpwgts,       ubvec,  ipc2redist,    options,    edgecut,       part,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
end

# Refine the quality of a partitioning
function ParMETIS_V3_RefineKway(vtxdist, xadj, adjncy, vwgt, adjwgt, wgtflag, numflag, ncon, nparts, tpwgts, ubvec, options, edgecut, part, comm)
  r = ccall((:ParMETIS_V3_RefineKway, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,       vwgt,     adjwgt,    wgtflag,    numflag,       ncon,     nparts,      tpwgts,       ubvec,    options,    edgecut,       part,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
...
function ParMETIS_V3_NodeND(vtxdist, xadj, adjncy, numflag, options, order, sizes, comm)
  r = ccall((:ParMETIS_V3_NodeND, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,    numflag,    options,      order,      sizes,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
end

function ParMETIS_V32_NodeND(vtxdist, xadj, adjncy, vwgt, numflag, mtype, rtype, p_nseps, s_nseps, ubfrac, seed, dbglvl, order, sizes, comm)
  r = ccall((:ParMETIS_V32_NodeND, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{real_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,       vwgt,    numflag,      mtype,      rtype,    p_nseps,    s_nseps,      ubfrac,       seed,     dbglvl,      order,      sizes,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
end

function ParMETIS_SerialNodeND(vtxdist, xadj, adjncy, numflag, options, order, sizes, comm)
  r = ccall((:ParMETIS_SerialNodeND, libparmetis), Cint,
            (Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}, Ptr{idx_t}),
                vtxdist,       xadj,     adjncy,    numflag,    options,      order,      sizes,       comm)
  r == METIS_OK || throw(MetisError(r))
  return nothing
